  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        washi: {
          DEFAULT: "hsl(var(--washi))",
          dark: "hsl(var(--washi-dark))",
        },
        cream: {
        ...
        "green-tea": {
          ...
          light: "hsl(var(--green-tea-light))",
        },
        matcha: "hsl(var(--matcha))",
        kintsugi: "hsl(var(--kintsugi))",
        "shou-sugi-ban": "hsl(var(--shou-sugi-ban))",
      },
      borderRadius: {
        lg: "var(--radius)",
